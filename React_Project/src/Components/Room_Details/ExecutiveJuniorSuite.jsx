...
const ExecutiveJuniorSuite = () => {
    return (
        <div className="container">
            <h2>Overview</h2>
            <img src={room1} alt="Executive Junior Suite" className="floating" />
            <p>
                The Executive Junior Suite is designed to provide guests with an elegant, comfortable, and spacious retreat. 
                Combining luxury with practicality, this suite is ideal for both business and leisure travelers.
            </p>
            ...
            <h2>Amenities</h2>
            <img src={bath1} alt="Bathroom" className="floating1" />
            <ul>
            ...
            <h2>Location</h2>
            <img src={city1} alt="City View" className="floating2" />
